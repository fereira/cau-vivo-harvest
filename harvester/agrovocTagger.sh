...
cd ..
java $HARVESTER_JAVA_OPTS -cp $CLASSPATH -Dprocess-task=tagger -Dharvester-task=tagger  edu.cornell.mannlib.harvester.tools.AgrovocTagger -X agrovocTagger.config.xml
